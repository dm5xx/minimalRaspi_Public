...
function subMitValue(bankNr, Value)
{
    ...
    fetch('http://'+url+'/Set'+bankNr+'/'+Value, { headers: myHeaders, timeout : 2000})
...
{ 
    fetch('http://'+url+'/Reset', { headers: myHeaders, timeout : 2000})
...
function lockSwitch()
{
    fetch('http://'+url+'/Lock', { headers: myHeaders, timeout : 2000})
    .then((response) => { return response})
    .then((data) => {
...
{
    fetch('http://'+url+'/UnLock', { headers: myHeaders, timeout : 2000})
    .then((response) => { return response})
    .then((data) => {
